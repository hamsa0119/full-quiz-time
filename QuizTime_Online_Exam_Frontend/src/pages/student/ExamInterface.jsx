...
import WebcamProctor from '../../components/student/WebcamProctor';
...
const ExamInterface = () => {
    ...
    return (
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', animation: 'fadeIn 0.3s ease' }}>
            ...
            {/* Webcam Proctoring */}
            <WebcamProctor 
                isExamActive={!isSubmitting && !isTimedOut}
                onInfraction={(msg) => {
                    console.warn("Proctoring Infraction:", msg);
                    // You can uncomment below to make webcam issues count as warnings
