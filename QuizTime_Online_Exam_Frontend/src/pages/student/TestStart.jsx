...
import quiztimeLogo from '../../assets/logo.png'; // Updated to use common logo
                ...
                <div style={{ position: 'relative', zIndex: 1 }}>
                    <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
                        <div style={{ width: '115px', height: '115px', borderRadius: '22px', background: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 0.75rem', boxShadow: 'var(--shadow-sm)' }}>
                            <img src={quiztimeLogo} alt="QuizTime Logo" style={{ width: '90%', height: '90%', objectFit: 'contain' }} />
                        </div>
                        <h1 style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--text-primary)', marginBottom: '0.2rem' }}>QuizTime</h1>
