...
import com.quiztime.exam.dto.QuestionResult;
import com.quiztime.exam.repository.EmailConfigRepository;
import com.quiztime.exam.repository.AdminRepository;
import com.quiztime.exam.repository.StudentExamCodeRepository;
import com.quiztime.exam.model.Admin;
import com.quiztime.exam.model.TestCategoryConfig;
import com.quiztime.exam.model.TestStudentGroup;
import com.quiztime.exam.model.StudentExamCode;
import jakarta.mail.*;
    ...
    public void sendSchedulingEmail(Student student, Test test, String examCode, String examDate) {
        ...
        try {
            ...
            String htmlContent = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'>" +
                    ...
                    +
                    "          <p style='margin: 8px 0 0; color: #6b7280; font-size: 15px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.05em;'>Online Exam Portal</p>"
                    +
                    "        </td>" +
                    "      </tr>" +
                    "      <tr>" +
                    ...
                    +
                    "                  IT Examination Center<br/><span style='color: #6b7280; font-weight: 400;'>Main Building<br/>" +
                    "                  City Center</span>" +
                    "                </p>" +
                    "              </td>" +
                    ...
                    "              Online Exam Center<br/>" +
                    "              Tel: <span style='color: #4b5563;'>(+00) 00 000 0000</span><br/>" +
                    "              Web: <a href='#' style='color: #000000; text-decoration: underline; font-weight: 500;'>www.examportal.com</a>"
                    +
                    "            </p>" +
                    "          </div>" +
                    "        </td>" +
    ...
    public void sendReschedulingEmail(Student student, Test test, String examCode, String examDate) {
        ...
        try {
            ...
            String htmlContent = "<html><head><meta name='viewport' content='width=device-width, initial-scale=1.0'>" +
                    ...
                    +
                    "          <img src='https://via.placeholder.com/150x45?text=Logo' alt='Exam Portal Logo' style='height: 45px; margin-bottom: 25px;'>"
                    +
                    ...
                    "              The venue remains the same: IT Examination Center. Please ensure you bring all required documents mentioned previously."
                    +
                    "            </p>" +
                    "          </div>" +
                    "          " +
                    ...
                    "              Online Exam Center<br/>" +
                    "              Tel: (+00) 00 000 0000 | <a href='#' style='color: #d97706; text-decoration: none; font-weight: 600;'>examportal.com</a>"
                    +
                    "            </p>" +
                    "          </div>" +
                    "        </td>" +
                    ...
                    +
                    "          &copy; 2026 Online Exam Portal. All Rights Reserved." +
                    "        </td>" +
                    "      </tr>" +
                    "    </table>" +
                    "  </center>" +
