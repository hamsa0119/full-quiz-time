...
const Results = () => {
    ...
    const handleExportCSV = (customData = null, customFilename = null) => {
        ...
        // ─────────────────────────────────────────────────────────────
        lines.push(`ONLINE EXAM SYSTEM – PERFORMANCE ANALYTICS REPORT`);
        ...
        const filename = customFilename || `Analytics_Report_${new Date().toISOString().split('T')[0]}.csv`;
    ...
    const handleExportPDF = (customData = null, customFilename = null) => {
        ...
        const timestamp = new Date().toLocaleString();
        const logoUrl = '/logo.png'; // Updated to a standard logo
        ...
        const filename = customFilename || `Professional_Report_${new Date().toISOString().split('T')[0]}.pdf`;
        doc.save(filename);
    };
