...
public class AdminController {
    ...
    @Autowired
    private com.quiztime.exam.service.AdminService adminService;
    ...
    public ResponseEntity<?> updateProfile(@PathVariable String currentUsername,
            @RequestBody com.quiztime.exam.dto.ProfileUpdateRequest request) {
        try {
    ...
    public ResponseEntity<?> changePassword(@PathVariable String username,
            @RequestBody com.quiztime.exam.dto.PasswordChangeRequest request) {
        try {
